...
import { SupplieDetailsComponent } from 'src/app/supplies/supplie-details/supplie-details.component';
...
export class SupplieListComponent implements OnInit {
  ...
  updateSupplie(id: number){
    this.router.navigate(['/updateSupplie_', id]);
  }

  add(){
    this.router.navigate(['/addSupplie_']);
  }
